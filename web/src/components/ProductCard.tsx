...
const ProductCard = ({ product }: { product: ProductInterface }) => {
    return (
        <div className="bg-white p-4 rounded-xl shadow min-h-[150px] flex flex-col h-full overflow-hidden w-full hover:scale-105 transition ease-in-out cursor-pointer">
